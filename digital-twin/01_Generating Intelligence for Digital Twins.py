...
# MAGIC
# MAGIC In this demo, we’ll create an EV Battery Manufacturing plant using Azure Digital Twins, with data and insights generated by Databricks:
# MAGIC
...
# MAGIC
# MAGIC Bootstrapping new ML projects can be long and inefficient.  
...
# MAGIC   - Uploads can either be regular (e.g. every hour) or sporadic
